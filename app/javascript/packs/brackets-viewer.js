    ...
    var e = {
            ...
            335: (e, t, n) => {
                ...
                t.createTitle = function(e) {
                    ...
                    return n.classList.add("match"), n.setAttribute("data-match-id", e.toString()), n.setAttribute("data-match-status", t.toString()), n
                    ...
                    const t = document.createElement("div");
                    return t.classList.add("participant"), null !== e && t.setAttribute("data-participant-id", e.toString()), t
                    ...
                    n.result && "win" === n.result && (e.classList.add("win"), void 0 === n.score && (t.innerText = o.abbreviations.win))
                ...
                }, t.addParticipantOrigin = function(e, t, n) {
                    const i = document.createElement("span");
                    "before" === n ? (i.innerText = `${t} `, e.prepend(i)) : "after" === n && (i.innerText = ` (${t})`, e.append(i))
                }, t.addParticipantImage = function(e, t) {
                    const n = document.createElement("img");
                    n.src = t, e.prepend(n)
                }, t.getBracketConnection = function(e, t, n, i) {
                    return "loser-bracket" === n ? {
                        connectPrevious: e > 1 && (e % 2 == 1 ? "square" : "straight"),
                    ...
                    n.connectPrevious && e.classList.add("connect-previous"), n.connectNext && t.classList.add("connect-next"), "straight" === n.connectPrevious && e.classList.add("straight"), "straight" === n.connectNext && t.classList.add("straight")
                }
            },
            886: (e, t, n) => {
                Object.defineProperty(t, "__esModule", {
                ...
                t.splitBy = function(e, t) {
                    ...
                    return t && "lower-bracket" === e && 1 === n ? i.abbreviations.seed : "lower-bracket" === e || "final-group" === e ? i.abbreviations.position : i.abbreviations.seed
            ...
            491: function(e, t, n) {
                ...
                function u(e, t, n) {
                    return "boolean" == typeof n ? o.default.t(`${e}.${t}`, {
                        returnObjects: !0
                    }) : o.default.t(`${e}.${t}`, n)
                }
                o.default.use(r.default).init({
                    fallbackLng: "en",
                    debug: !0,
                    resources: {}
                }), Object.keys(a.locales).forEach((e => o.default.addResourceBundle(e, "translation", a.locales[e]))), t.getOriginHint = function(e, t, n, i) {
                    if (1 === e) {
                        if ("single-bracket" === i) return e => u("origin-hint", "seed", {
                            position: e
                        });
                        if ("winner-bracket" === i) return e => u("origin-hint", "seed", {
                            position: e
                        });
                        if ("loser-bracket" === i && n) return e => u("origin-hint", "seed", {
                            position: e
                        })
                    }
                    if (c.isMajorRound(e) && "loser-bracket" === i) {
                        if (e === t - 2) return e => u("origin-hint", "winner-bracket-semi-final", {
                            position: e
                        });
                        if (e === t) return () => u("origin-hint", "winner-bracket-final");
                        const i = Math.ceil((e + 1) / 2);
                        return n ? e => u("origin-hint", "winner-bracket", {
                            round: i - 1,
                            position: e
                        }) : e => u("origin-hint", "winner-bracket", {
                            round: i,
                            position: e
                        })
                    }
                }, t.getFinalOriginHint = function(e, t) {
                    return "consolation_final" === e ? e => u("origin-hint", "consolation-final", {
                        position: e
                    }) : 1 === t ? () => u("origin-hint", "grand-final") : void 0
                    ...
                    const o = u("match-label", "winner-bracket" === i ? "winner-bracket" : "loser-bracket" === i ? "loser-bracket" : "standard-bracket"),
                        ...
                        a = t === n;
                    if ("single-bracket" === i) {
                        if (r) return u("match-label", "standard-bracket-semi-final", {
                            matchNumber: e
                        });
                        if (a) return u("match-label", "standard-bracket-final")
                    }
                    return r ? u("match-label", "double-elimination-semi-final", {
                        matchPrefix: o,
                        matchNumber: e
                    }) : a ? u("match-label", "double-elimination-final", {
                        matchPrefix: o
                    ...
                    return "consolation_final" === e ? u("match-label", "consolation-final") : 1 === n ? u("match-label", "grand-final-single") : u("match-label", "grand-final", {
                        roundNumber: t
                    })
                    ...
                    return u("common", "group-name", {
                        groupNumber: e
                    })
                }, t.getRoundName = function(e, t) {
                    return e === t ? u("common", "round-name-final") : u("common", "round-name", {
                        roundNumber: e
                    })
                }, t.getWinnerBracketRoundName = function(e, t) {
                    return e === t ? u("common", "round-name-winner-bracket-final") : u("common", "round-name-winner-bracket", {
                        roundNumber: e
                    })
                }, t.getLoserBracketRoundName = function(e, t) {
                    return e === t ? u("common", "round-name-loser-bracket-final") : u("common", "round-name-loser-bracket", {
                        roundNumber: e
                    })
                }, t.abbreviations = {
                ...
                }, t.bestOfX = e => u("common", "best-of-x", {
                    x: e
                }), t.BYE = u("common", "bye"), t.headers = {
            ...
            825: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.BracketsViewer = void 0, n(373);
                const a = n(886),
                    s = r(n(335)),
                    c = r(n(491));
                class u {
                    constructor() {
                        this.participantRefs = {}, this.participants = [], this.participantImages = []
                    }
                    render(e, t) {
                        const n = document.createDocumentFragment();
                        this.config = {
                            participantOriginPlacement: (null == t ? void 0 : t.participantOriginPlacement) || "before",
                            separatedChildCountLabel: void 0 !== (null == t ? void 0 : t.separatedChildCountLabel) && t.separatedChildCountLabel,
                            showSlotsOrigin: void 0 === (null == t ? void 0 : t.showSlotsOrigin) || t.showSlotsOrigin,
                            showLowerBracketSlotsOrigin: void 0 === (null == t ? void 0 : t.showLowerBracketSlotsOrigin) || t.showLowerBracketSlotsOrigin,
                            highlightParticipantOnHover: void 0 === (null == t ? void 0 : t.highlightParticipantOnHover) || t.highlightParticipantOnHover
                        }, this.participants = e.participants, e.participants.forEach((e => this.participantRefs[e.id] = [])), e.stages.forEach((t => this.renderStage(n, {
                            ...e,
                            stages: [t],
                    ...
                    addLocale(e, t) {
                        c.i18next.addResourceBundle(e, "translation", t), c.i18next.changeLanguage()
                    }
                    setParticipantImages(e) {
                        this.participantImages = e
                    }
                    renderStage(e, t) {
                        const n = t.stages[0],
                    ...
                    createParticipant(e, t, n, i) {
                        const o = {
                            participant: s.createParticipantContainer(e && e.id),
                            name: s.createNameContainer(),
                            result: s.createResultContainer()
                        };
                        return null === e ? o.name.innerText = c.BYE : this.renderParticipant(o, e, t, n, i), o.participant.append(o.name, o.result), e && null !== e.id && this.setupMouseHover(e.id, o.participant), o.participant
                    }
                    ...
                    renderHint(e, t, n, i) {
                        void 0 !== n && void 0 !== t.position && this.config.showSlotsOrigin && (this.config.showLowerBracketSlotsOrigin || "loser-bracket" !== i) && s.setupHint(e, n(t.position))
                    }
                    ...
                    setupMouseHover(e, t) {
                        ...
                        n.push(t), t.addEventListener("mouseover", (() => {
                    ...
                    S = function() {
                        ...
                        return (0, o.Z)(e, [{
                            ...
                            value: function(e) {
                                ...
                                this.services = e, this.options = c(t, this.options || {}, {
                                ...
                                }), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = n, this.addDetector(p), this.addDetector(d), this.addDetector(h), this.addDetector(b), this.addDetector(y), this.addDetector(k), this.addDetector(w), this.addDetector(x)
                            }
                        }, {
                            key: "addDetector",
                            value: function(e) {
            ...
            181: (e, t, n) => {
                ...
                function S(e, t, n) {
                    for (var i in t) "__proto__" !== i && "constructor" !== i && (i in e ? "string" == typeof e[i] || e[i] instanceof String || "string" == typeof t[i] || t[i] instanceof String ? n && (e[i] = t[i]) : S(e[i], t[i], n) : e[i] = t[i]);
                    return e
                }
                ...
                var C = "undefined" != typeof window && window.navigator && window.navigator.userAgent && window.navigator.userAgent.indexOf("MSIE") > -1,
                    P = function(e) {
                        function t(e) {
                            ...
                            return (0, a.Z)(this, t), n = u(this, l(t).call(this)), C && h.call(c(n)), n.data = e || {}, n.options = i, void 0 === n.options.keySeparator && (n.options.keySeparator = "."), n
                        }
                    ...
                    F = function(e) {
                        function t(e) {
                            var n, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                            return (0, a.Z)(this, t), n = u(this, l(t).call(this)), C && h.call(c(n)), b(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, c(n)), n.options = i, void 0 === n.options.keySeparator && (n.options.keySeparator = "."), n.logger = g.create("translator"), n
                        }
                        return d(t, e), (0, s.Z)(t, [{
                            key: "changeLanguage",
                            value: function(e) {
                                ...
                                if (x && m && S && k.indexOf(y) < 0 && ("string" != typeof w || "[object Array]" !== y)) {
                                    ...
                                    if (E || N || _) {
                                        ...
                                        var H = function(e, t, i) {
                                            a.options.missingKeyHandler ? a.options.missingKeyHandler(e, p, t, _ ? i : m, _, n) : a.backendConnector && a.backendConnector.saveMissing && a.backendConnector.saveMissing(e, p, t, _ ? i : m, _, n), a.emit("missingKey", e, p, t, m)
                                        };
                                        this.options.saveMissing && (this.options.saveMissingPlurals && F ? A.forEach((function(e) {
                                            a.pluralResolver.getSuffixes(e).forEach((function(t) {
                                                H([e], u + t, n["defaultValue".concat(t)] || M)
                                            }))
                                        })) : H(A, u, M))
                                    }
                            ...
                            value: function(e, t, n, i, o) {
                                ...
                                return null != e && f && f.length && !1 !== n.applyPostProcessor && (e = N.handle(f, e, t, this.options && this.options.postProcessPassResolved ? r({
                                    i18nResolved: i
                                }, n) : n, this)), e
                            }
                        }, {
                        ...
                        return (0, s.Z)(e, [{
                            ...
                            value: function(e) {
                                if ("string" == typeof e && e.indexOf("-") > -1) {
                                    ...
                                    })) : 2 === n.length ? (n[0] = n[0].toLowerCase(), n[1] = n[1].toUpperCase(), t.indexOf(n[1].toLowerCase()) > -1 && (n[1] = j(n[1].toLowerCase()))) : 3 === n.length && (n[0] = n[0].toLowerCase(), 2 === n[1].length && (n[1] = n[1].toUpperCase()), "sgn" !== n[0] && 2 === n[2].length && (n[2] = n[2].toUpperCase()), t.indexOf(n[1].toLowerCase()) > -1 && (n[1] = j(n[1].toLowerCase())), t.indexOf(n[2].toLowerCase()) > -1 && (n[2] = j(n[2].toLowerCase()))), n.join("-")
                                }
                ...
                var A = function() {
                    ...
                    D = function() {
                        function e() {
                            ...
                            (0, a.Z)(this, e), this.logger = g.create("interpolator"), this.options = t, this.format = t.interpolation && t.interpolation.format || function(e) {
                                return e
                            }, this.init(t)
                        }
                        return (0, s.Z)(e, [{
                            ...
                            value: function(e, t) {
                                ...
                                for (s.applyPostProcessor = !1, delete s.defaultValue; n = this.nestingRegexp.exec(e);) {
                                    ...
                                    "string" != typeof i && (i = v(i)), i || (this.logger.warn("missed to resolve ".concat(n[1], " for nesting ").concat(e)), i = ""), l && (i = u.reduce((function(e, t) {
                    ...
                    I = function(e) {
                        function t(e, n, i) {
                            ...
                            return (0, a.Z)(this, t), o = u(this, l(t).call(this)), C && h.call(c(o)), o.backend = e, o.store = n, o.services = i, o.languageUtils = i.languageUtils, o.options = r, o.logger = g.create("backendConnector"), o.state = {}, o.queue = [], o.backend && o.backend.init && o.backend.init(i, r.backend, r), o
                        }
                        return d(t, e), (0, s.Z)(t, [{
                            key: "queueLoad",
                            value: function(e, t, n, i) {
                                ...
                                return e.forEach((function(e) {
                                    ...
                                    t.forEach((function(t) {
                                        ...
                                        !n.reload && o.store.hasResourceBundle(e, t) ? o.state[s] = 2 : o.state[s] < 0 || (1 === o.state[s] ? a.indexOf(s) < 0 && a.push(s) : (o.state[s] = 1, i = !1, a.indexOf(s) < 0 && a.push(s), r.indexOf(s) < 0 && r.push(s), c.indexOf(t) < 0 && c.push(t)))
                                    })), i || s.push(e)
                ...
                const W = new(function(e) {
                    function t() {
                        ...
                        if ((0, a.Z)(this, t), e = u(this, l(t).call(this)), C && h.call(c(e)), e.options = U(n), e.services = {}, e.logger = g, e.modules = {
                                external: []
                    ...
                    return d(t, e), (0, s.Z)(t, [{
                        ...
                        value: function() {
                            ...
                            if ("function" == typeof t && (n = t, t = {}), t.whitelist && !t.supportedLngs && this.logger.deprecate("whitelist", 'option "whitelist" will be renamed to "supportedLngs" in the next major - please make sure to rename this option asap.'), t.nonExplicitWhitelist && !t.nonExplicitSupportedLngs && this.logger.deprecate("whitelist", 'options "nonExplicitWhitelist" will be renamed to "nonExplicitSupportedLngs" in the next major - please make sure to rename this option asap.'), this.options = r({}, H(), this.options, U(t)), this.format = this.options.interpolation.format, n || (n = V), !this.options.isClone) {
                                ...
                                var a = this.services;
                                a.logger = g, a.resourceStore = this.store, a.languageUtils = o, a.pluralResolver = new A(o, {
                                    prepend: this.options.pluralSeparator,
                                    compatibilityJSON: this.options.compatibilityJSON,
                                    simplifyPluralSuffix: this.options.simplifyPluralSuffix
                                }), a.interpolator = new D(this.options), a.utils = {
                                    hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
                                }, a.backendConnector = new I(i(this.modules.backend), a.resourceStore, a, this.options), a.backendConnector.on("*", (function(t) {
                        ...
                        value: function(e) {
                            ...
                            return "backend" === e.type && (this.modules.backend = e), ("logger" === e.type || e.log && e.warn && e.error) && (this.modules.logger = e), "languageDetector" === e.type && (this.modules.languageDetector = e), "i18nFormat" === e.type && (this.modules.i18nFormat = e), "postProcessor" === e.type && N.addPostProcessor(e), "3rdParty" === e.type && this.modules.external.push(e), this
                        }
                    }, {
                        key: "changeLanguage",
                        value: function(e, t) {
                        ...
                        value: function() {
                            ...
                            }, a.translator = new F(a.services, a.options), a.translator.on("*", (function(e) {
                                for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), i = 1; i < t; i++) n[i - 1] = arguments[i];
