...
! function(e) {
    ...
    const r = n(5),
        i = n(0);
    t.getMatchHint = function(e, t, n) { if (!n && 1 === e) return e => "Seed " + e; if (n && i.isMajorRound(e)) { const n = Math.ceil((e + 1) / 2); let r = e => `Loser of WB ${n}.${e}`; return e === t - 2 && (r = e => "Loser of WB Semi " + e), e === t && (r = () => "Loser of WB Final"), r } }, t.getMatchLabel = function(e, t, n, r) {
        let i = "M";
        r ? i = "LB" : !1 === r && (i = "WB");
        const o = t === n - 1,
            a = t === n;
        let c = `${i} ${t}.${e.number}`;
        return !r && o && (c = "Semi " + e.number), a && (c = "Final"), c
    }, t.getFinalMatchLabel = function(e, t, n) { return "consolation_final" === e ? "Consolation Final" : t(n) }, t.getFinalMatchHint = function(e, t) { return "consolation_final" === e ? e => "Loser of Semi " + e : 0 === t ? () => "Winner of LB Final" : void 0 }, t.getMatchStatus = function(e) {
        switch (e) {
    ...
    }, t.getGrandFinalName = function(e) { return 1 === e.length ? () => "Grand Final" : e => "GF Round " + (e + 1) }, t.getGroupName = function(e) { return "Round " + e }, t.getRoundName = function(e) { return "Round " + e }, t.getWinnerBracketRoundName = function(e) { return "WB Round " + e }, t.getLoserBracketRoundName = function(e) { return "LB Round " + e }
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }), t.Status = void 0,
        function(e) { e[e.Locked = 0] = "Locked", e[e.Waiting = 1] = "Waiting", e[e.Ready = 2] = "Ready", e[e.Running = 3] = "Running", e[e.Completed = 4] = "Completed", e[e.Archived = 5] = "Archived" }(t.Status || (t.Status = {}))
}]);